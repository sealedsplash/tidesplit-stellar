  ...
  return (
    <div className="ocean-shell">
      ...
      <header className="topbar">
        <a className="brand" href="#top" aria-label="Splash home"><span className="brand-drop">S</span><span>SPLASH</span></a>
      ...
      <main id="top">
        ...
        <section className="wallet-section" id="wallets" aria-labelledby="wallet-title">
          <div><p className="eyebrow">01 — ENTER THE CURRENT</p><h2 id="wallet-title">Choose your wallet</h2><p>Powered by StellarWalletsKit. Testnet only; your keys never touch Splash.</p></div>
        ...
        <section className="workspace" id="workspace" aria-labelledby="workspace-title">
          ...
          {!wallet.address ? <div className="locked-state"><span>≈</span><h3>Connect to enter the workspace</h3><p>Select any available wallet above. Splash checks Testnet before enabling writes.</p></div> : !DEFAULT_CONTRACT_ID ? <div className="locked-state"><span>◌</span><h3>Contract deployment queued</h3><p>Run the Testnet Deploy workflow; it writes the real Contract ID back to this repository.</p></div> : <div className="workspace-grid">
